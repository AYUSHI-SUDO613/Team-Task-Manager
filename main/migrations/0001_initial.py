# Generated by Django 5.0.4 on 2026-05-14 16:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('todo', 'To Do'), ('in-progress', 'In Progress'), ('in-review', 'In Review'), ('completed', 'Completed')], default='todo', max_length=15)),
            ...
            options={
                'ordering': ['order'],
                'indexes': [models.Index(fields=['project', 'status'], name='main_task_project_035c44_idx'), models.Index(fields=['assignee'], name='main_task_assigne_862a81_idx'), models.Index(fields=['created_by'], name='main_task_created_124f92_idx')],
            },
        ),
    ]
